    ...
    return (
        <div onTouchStart={handleTouchStart}
            ...
            <i onMouseEnter={stopAutoPlay}
                onMouseLeave={startAutoPlay} onClick={prevItem} className="fa-solid fa-chevron-left"></i>
            {
            ...
            <i onMouseEnter={stopAutoPlay}
                onMouseLeave={startAutoPlay} onClick={nextItem} className="fa-solid fa-chevron-right"></i>
